...
This node acts as a state machine for requesting the goal action server to a point received from the user\+\_\+interface client or cancel target based on the request sent from the user\+\_\+interface ~\newline
